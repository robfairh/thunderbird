...
Point(1) = {-0.05, -0.05, 0, h};
Point(2) = {0.05, -0.05, 0, h};
Point(3) = {-0.05, 0.05, 0, h};
Point(4) = {0.05, 0.05, 0, h};

Point(5) = {-0.004, -0.05, 0, h};
Point(6) = {0.004, -0.05, 0, h};
Point(7) = {-0.004, -0.038, 0, h};
Point(8) = {0.004, -0.038, 0, h};
Point(9) = {-0.004, -0.025, 0, h};
Point(10) = {0.004, -0.025, 0, h};
Point(11) = {-0.004, -0.012, 0, h};
Point(12) = {0.004, -0.012, 0, h};
Point(13) = {-0.004, 0., 0, h};
Point(14) = {0.004, 0., 0, h};
