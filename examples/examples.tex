...
%
%$https://github.com/robfairh/mymoltres/tree/new_kernels/examples/01/$\\
%
%Kernels involved:
%\begin{description}[font=$\bullet$\scshape\bfseries]
%	\item[] GroupDiffusion
%\end{description}
%
%This is case is to see if the App was working.
%It calculates two variables: flux1 ($\phi_{1}$) and flux2 ($\phi_{2}$). 
%
%Equations involved:
%\begin{equation}
%\nabla.(D_{1}\nabla\phi_{1})=0
...
%Boundary conditions:
%\begin{description}[]
%	\item[] $\phi_{1}('left')=1$ and $\phi_{1}('right')=0$
%	\item[] $\phi_{2}('left')=2$ and $\phi_{2}('right')=1$
%\end{description}
%
%The user defines $D_{1}=1.$ and $D_{2}=1.$ for the kernels manually.
%The results are presented in Figure \ref{fig:exa01}.
%
%\begin{figure*}[!h]
%	\centering
%	\begin{subfigure}[t]{0.4\textwidth}
%		\centering
%		\includegraphics[width=\linewidth]{01/Flux1.png} 
%		\caption{$\phi_{1}$.}
%		\label{fig:exa01-flux1}
%	\end{subfigure}
%	\vspace{1cm}
%	\begin{subfigure}[t]{0.4\textwidth}
%		\centering
%		\includegraphics[width=\linewidth]{01/Flux2.png} 
%		\caption{$\phi_{2}$.}
%		\label{fig:exa01-flux2}
%	\end{subfigure}
%	\hfill
...
%This example can be found in:
%
%$https://github.com/robfairh/mymoltres/tree/new_kernels/examples/02/$\\
%
%Kernels involved:
%\begin{description}[font=$\bullet$\scshape\bfseries]
%    \item[] NtTimeDerivative
...
%\end{description}
%
%This is case adds the time derivative in one of the equations.
%It calculates two variables: flux1 ($\phi_{1}$) and flux2 ($\phi_{2}$). 
%
%Equations involved:
%\begin{equation}
...
%\begin{description}[]
%	\item[] $\phi_{1}('left')=1$ and $\phi_{1}('right')=0$
%	\item[] $\phi_{2}('left')=1$ and $\phi_{2}('right')=0$
%\end{description}
%
%The user defines $\frac{1}{v_{1}}=1$, $D_{1}=1$ and $D_{2}=1$ for the kernels manually.
%The results are presented in Figure \ref{fig:exa02}.
%
%\begin{figure*}[!h]
%	\centering
%	\begin{subfigure}[t]{0.4\textwidth}
%		\centering
%		\includegraphics[width=\linewidth]{02/flux1-t=0.png} 
%		\caption{$\phi_{1}$ at $t=0$.}
%		\label{fig:exa02-flux1t0}
%	\end{subfigure}
%	\vspace{1cm}
%	\begin{subfigure}[t]{0.4\textwidth}
%		\centering
%		\includegraphics[width=\linewidth]{02/flux1-t=50.png} 
%		\caption{$\phi_{1}$ at $t=50$.}
%		\label{fig:exa02-flux1t50}
%	\end{subfigure}
%	\hfill
%	\caption{Flux.}
%	\label{fig:exa02}
...
%This example can be found in:
%
%$https://github.com/robfairh/mymoltres/tree/new_kernels/examples/03/$\\
%
%Kernels involved:
%\begin{description}[font=$\bullet$\scshape\bfseries]
%	\item[] GroupDiffusion
...
%\end{description}
%
%This is case adds the a few more terms of the diffusion equations. This time the equations are coupled. I am not completely sure that the function
%\textit{InScatter::computeQpResidual()} works 100$\%$ properly.
%It calculates two variables: flux1 ($\phi_{1}$) and flux2 ($\phi_{2}$).
%
%Equations involved:
%\begin{equation}
...
%\end{description}
%
%The user defines $D_{1}=1$, $D_{2}=1$, $\Sigma^{r}_{1}=1$, and $\Sigma^{s}_{1-2}=1$ for the kernels manually.
%The results are presented in Figure \ref{fig:exa03}.
%
%\begin{figure*}[!h]
%	\centering
%	\begin{subfigure}[t]{0.4\textwidth}
%		\centering
%		\includegraphics[width=\linewidth]{03/flux2.png} 
%		\caption{$\phi_{1}$.}
%		\label{fig:exa03-flux1}
%	\end{subfigure}
%	\vspace{1cm}
%	\begin{subfigure}[t]{0.4\textwidth}
%		\centering
%		\includegraphics[width=\linewidth]{03/flux2.png} 
%		\caption{$\phi_{2}$.}
%		\label{fig:exa03-flux2}
%	\end{sub%\begin{figure*}[!h]
%	\centering
%	\includegraphics[width=\linewidth]{05/temperature.png} 
%	\hfill
%	\caption{Temperature.}
%	\label{fig:exa05}
%\end{figure*}figure}
...
%This example can be found in:
%
%$https://github.com/robfairh/mymoltres/tree/new_kernels/examples/05/$\\
%
%Kernels involved:
%\begin{description}[font=$\bullet$\scshape\bfseries]
%	\item[] TempDiffusion
