...
protected:
  ...
  MaterialProperty<std::vector<Real>> & _diffcoefA;
  MaterialProperty<std::vector<Real>> & _diffcoefB;
  ...
  MaterialProperty<std::vector<Real>> & _d_diffcoefA_d_temp;
  MaterialProperty<std::vector<Real>> & _d_diffcoefB_d_temp;
  ...
  std::vector<std::vector<Real>> _diffcoeffA_consts = std::vector<std::vector<Real>>(2);
  std::vector<std::vector<Real>> _diffcoeffB_consts = std::vector<std::vector<Real>>(2);
