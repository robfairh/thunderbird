...
registerMooseObject("ExampleApp", GenericMoltresMaterial);
                                              ...
                                              std::vector<std::string> xsec_names)
{
  ...
  _diffcoeffA_consts = xsec_map["DIFFCOEFA"];
  _diffcoeffB_consts = xsec_map["DIFFCOEFB"];
...
GenericMoltresMaterial::dummyComputeQpProperties()
{
  for (decltype(_num_groups) i = 0; i < _num_groups; ++i)
  {
    ...
    _diffcoefA[_qp][i] = _xsec_map["DIFFCOEFA"][i];
    _diffcoefB[_qp][i] = _xsec_map["DIFFCOEFB"][i];
    ...
    _d_diffcoefA_d_temp[_qp][i] = _xsec_map["DIFFCOEFA"][i];
    _d_diffcoefB_d_temp[_qp][i] = _xsec_map["DIFFCOEFB"][i];
...
GenericMoltresMaterial::fuelBicubic()
{
  for (decltype(_num_groups) i = 0; i < _num_groups; ++i)
  {
    ...
    _diffcoefA[_qp][i] =
        _xsec_bicubic_spline_interpolators["DIFFCOEFA"][i].sample(_temperature[_qp], _other_temp);
    _diffcoefB[_qp][i] =
        _xsec_bicubic_spline_interpolators["DIFFCOEFB"][i].sample(_temperature[_qp], _other_temp);
    _recipvel[_qp][i] =
    ...
    _d_fisse_d_temp[_qp][i] = _xsec_bicubic_spline_interpolators["FISSE"][i].sampleDerivative(
                                  _temperature[_qp], _other_temp, 1) *
                              1e6 * 1.6e-19; // convert from MeV to Joules
    _d_diffcoefA_d_temp[_qp][i] = _xsec_bicubic_spline_interpolators["DIFFCOEFA"][i].sampleDerivative(
        _temperature[_qp], _other_temp, 1);
    _d_diffcoefB_d_temp[_qp][i] = _xsec_bicubic_spline_interpolators["DIFFCOEFB"][i].sampleDerivative(
        _temperature[_qp], _other_temp, 1);
...
GenericMoltresMaterial::moderatorBicubic()
{
  for (decltype(_num_groups) i = 0; i < _num_groups; ++i)
  {
    ...
    _fisse[_qp][i] =
        ...
        1e6 * 1.6e-19; // convert from MeV to Joules
    _diffcoefA[_qp][i] =
        _xsec_bicubic_spline_interpolators["DIFFCOEFA"][i].sample(_other_temp, _temperature[_qp]);
    _diffcoefB[_qp][i] =
        _xsec_bicubic_spline_interpolators["DIFFCOEFB"][i].sample(_other_temp, _temperature[_qp]);
    _recipvel[_qp][i] =
...
GenericMoltresMaterial::leastSquaresComputeQpProperties()
{
  for (decltype(_num_groups) i = 0; i < _num_groups; ++i)
  {
    ...
    _diffcoefA[_qp][i] = _diffcoeffA_consts[0][i] * _temperature[_qp] + _diffcoeffA_consts[1][i];
    _diffcoefB[_qp][i] = _diffcoeffB_consts[0][i] * _temperature[_qp] + _diffcoeffB_consts[1][i];
    ...
    _d_diffcoefA_d_temp[_qp][i] = _diffcoeffA_consts[0][i];
    _d_diffcoefB_d_temp[_qp][i] = _diffcoeffB_consts[0][i];
...
GenericMoltresMaterial::computeQpProperties()
{
  ...
  _diffcoefA[_qp].resize(_vec_lengths["DIFFCOEFA"]);
  _diffcoefB[_qp].resize(_vec_lengths["DIFFCOEFB"]);
  ...
  _d_diffcoefA_d_temp[_qp].resize(_vec_lengths["DIFFCOEFA"]);
  _d_diffcoefB_d_temp[_qp].resize(_vec_lengths["DIFFCOEFB"]);
