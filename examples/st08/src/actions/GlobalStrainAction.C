...
registerMooseAction("ExampleApp", GlobalStrainAction, "add_user_object");

registerMooseAction("ExampleApp", GlobalStrainAction, "add_scalar_kernel");

registerMooseAction("ExampleApp", GlobalStrainAction, "add_material");

registerMooseAction("ExampleApp", GlobalStrainAction, "add_aux_variable");

registerMooseAction("ExampleApp", GlobalStrainAction, "add_aux_kernel");
