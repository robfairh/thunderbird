...
registerMooseAction("ExampleApp", GeneralizedPlaneStrainAction, "add_scalar_kernel");

registerMooseAction("ExampleApp", GeneralizedPlaneStrainAction, "add_kernel");

registerMooseAction("ExampleApp", GeneralizedPlaneStrainAction, "add_user_object");
