...
registerMooseAction("ExampleApp", LineElementAction, "meta_action");

registerMooseAction("ExampleApp", LineElementAction, "setup_mesh_complete");

registerMooseAction("ExampleApp", LineElementAction, "add_variable");

registerMooseAction("ExampleApp", LineElementAction, "add_aux_variable");

registerMooseAction("ExampleApp", LineElementAction, "add_kernel");

registerMooseAction("ExampleApp", LineElementAction, "add_aux_kernel");

registerMooseAction("ExampleApp", LineElementAction, "add_nodal_kernel");

registerMooseAction("ExampleApp", LineElementAction, "add_material");
