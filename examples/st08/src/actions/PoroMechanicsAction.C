...
registerMooseAction("ExampleApp", PoroMechanicsAction, "setup_mesh_complete");

registerMooseAction("ExampleApp", PoroMechanicsAction, "validate_coordinate_systems");

registerMooseAction("ExampleApp", PoroMechanicsAction, "add_kernel");
