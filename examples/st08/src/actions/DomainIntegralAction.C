...
registerMooseAction("ExampleApp", DomainIntegralAction, "add_user_object");

registerMooseAction("ExampleApp", DomainIntegralAction, "add_aux_variable");

registerMooseAction("ExampleApp", DomainIntegralAction, "add_aux_kernel");

registerMooseAction("ExampleApp", DomainIntegralAction, "add_postprocessor");

registerMooseAction("ExampleApp", DomainIntegralAction, "add_material");
